        ...
        <div className={`row-no-padding`}>
          <div className={`page-body-container col-xs-12`}>
            <div className={`col-xs-12`}>
              <div className={`${Products.panelContentContainer} ${Shadow.containerShadow} col-xs-12 col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2`} >

                {/* Title */}

                <h3 className={`${Products.panelTitle} col-xs-12`}><span className={`bold`}>OVER</span> 50{`'`}S INSURANCE</h3>
                <div className="col-xs-12">
                  <div className="col-xs-12">
