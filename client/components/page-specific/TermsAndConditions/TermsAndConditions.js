        ...
        <div className={`${Products.panelContentContainer} ${Shadow.containerShadow} container product-container`}>
          ...
          <div className={`${Products.panelTextContainer} col-xs-12`}>
            ...
            <div className={`${Products.sectionText}`}>
              <p>The rights in the designs, pictures, logos, photographs and content of this site are owned by or licensed to SimplyLifeInsurance.com. They are protected by copyright, trademarks and other intellectual property rights. You may not copy, reproduce, modify, distribute, republish, display, post or transmit any part of this site without the written permission of SimplyLifeInsurance.com. You may view or print individual pages only for your own personal use.</p>
            </div><br/>
            ...
            <div className={`${Products.sectionText}`}>
              <p>We try to ensure the accuracy of all of the content. However, we do not accept any liability for the use made by you of the content. The content of this site should only be used for information purposes and you should not rely on it to make (or refrain from making) any decision or take (or refrain from taking) any action.</p>
        			<p>The site is for your personal use and is not to be used for any commercial purpose. As a result, SimplyLifeInsurance.com will not be responsible in any circumstances for your loss of profits. SimplyLifeInsurance.com will also not be responsible for any loss including wasted expenditure, corruption or destruction of data unless the loss results from something SimplyLifeInsurance.com has done wrong.</p>
        			<p>SimplyLifeInsurance.com is not liable for any damages or losses resulting from your inability to use this site. SimplyLifeInsurance.com cannot promise that the site will be uninterrupted or entirely error free. Because of the nature of the internet, the site is provided on an "as available" basis. SimplyLifeInsurance.com will not be responsible to you if we are unable to provide the site for any reason beyond our control.</p>
            </div><br/>

            {/* Point 3 */}
            <h4 className={`${Products.sectionHeader}`} >3. Content and advertisements</h4>
            <div className={`${Products.sectionText}`}>
              <p>This site also provides links to and content from other internet sites and resources. Because SimplyLifeInsurance.com has no control over these sites and resources, you acknowledge and agree that SimplyLifeInsurance.com is not responsible for the availability of these external sites or resources and does not endorse and is not responsible for any content, advertising products, services or other materials on or available from these sites or resources.</p>
            </div><br/>
            ...
            <div className={`${Products.sectionText}`}>
              <p>These terms and your use of this site are governed by and construed in accordance with the laws of England and Wales and any disputes will be decided only by the Courts of England and Wales.</p>
        			<p>This site is owned and operated by SimplyLifeInsurance.com. If you have any queries, please <a href="/responsive-contact-us.cfm">contact us.</a></p>
        			<p>&nbsp;</p>
            </div>
