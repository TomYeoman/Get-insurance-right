          ...
          <div className={`${Footer_.sectionTop}`}>
             <div className="row-no-padding footerMenuTop container">
                ...
                <div className="row-no-padding">
                   <ul className={`col-xs-12 col-sm-12 text-center`}>
                ...
                <div className={`footerMenuBottom`}>
                    ...
                    <div className="col-xs-12">
                        <div className={`${Footer_.companyInfo} hidden-xs text-center col-xs-12 col-sm-10 col-lg-8 col-sm-offset-1 col-lg-offset-2`}>
                            <p><span className={`bold`}>SimplyLifeInsurance.com</span> is a trading name of British Life Ltd, a company registered in England no. 05559125.
                    ...
                    <div className="col-xs-12">
                        <div className={`${Footer_.companyInfo} text-center col-xs-12 col-sm-10 col-lg-8 col-sm-offset-1 col-lg-offset-2`}>
                            <p><span className={`bold`}>Simplylifeinsurance.com</span> is an independent website created to help customers find the best possible life cover quote for their circumstances. We work with FCA authorised advisers who search and compare life insurance policies from leading life insurers for the best deals available. Our service is <span className={`bold`}>100%</span> free to use and you are under no obligation to accept any of the quotes you receive.</p>
                        </div>
                    </div>
